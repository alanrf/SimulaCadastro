Com base no fluxo de desenvolvimento de um aplicativo para a simulação de um cadastro de usuário. Desenvolva o aplicativo com duas telas principais (activities) de acordo com a definição a seguir:
